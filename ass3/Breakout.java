...
public class Breakout extends GraphicsProgram {
	...
	// application width is set by combination of NBRICK_ROWS, NBRICKS_PER_ROW
	// and BRICK_WIDTH
	...
	private void moveBall() {
		...
		println(vx + " " + vy);
		if (obj != null && obj.getHeight() == 8) { // checks if obj is brick by
													// it's height
			totalBricks--;
			...
			// at the end of game speed will be 2x the original if no hps are
			// lost
